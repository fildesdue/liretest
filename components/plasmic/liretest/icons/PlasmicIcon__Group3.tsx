...
export function Group3Icon(props: Group3IconProps) {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M24 11.672c-6.806 0-12.328 5.522-12.328 12.328 0 6.806 5.522 12.328 12.328 12.328 6.806 0 12.328-5.522 12.328-12.328 0-6.806-5.522-12.328-12.328-12.328zm0 20.325a7.998 7.998 0 010-15.994 7.998 7.998 0 010 15.994zm15.694-20.813a2.879 2.879 0 11-2.878-2.878 2.885 2.885 0 012.878 2.878z"
        }
        fill={"currentColor"}
      ></path>
    </svg>
